...
export interface Mutation {
  ...
  SetMainCredit: SetMainCreditResponse;
  AddNewDriver: AddNewDriverResponse;
...
export interface SetMainCreditMutationArgs {
  creditId: number;
}
...
export interface SetMainCreditResponse {
  ok: boolean;
  error: string | null;
}
